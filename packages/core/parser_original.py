...
class EdiParser:
    ...
    def parse(self) -> EdiRoot:
        ...
        elif transaction_type == "276" or transaction_type == "277":
            return self._parse_276_277(segment_lists)
        else:
        ...
        for segment in segments:
            if segment[0] == "ST" and len(segment) > 1:
                ...
                if transaction_code == "837":
                    ...
                    return "271"
                elif transaction_code == "276":
                    return "276"
                elif transaction_code == "277":
                    return "277"
    ...
    def _parse_276_277(self, segments: list) -> EdiRoot:
        """Parse 276/277 Claim Status Inquiry/Response transaction."""
        root = EdiRoot()
        ...
        # Parse 276/277 specific content
        parser_276 = Parser276(segments)
        healthcare_transaction = parser_276.parse()
        ...
        # Create a generic transaction wrapper for the 276/277 data
        transaction = Transaction(
            transaction_set_code=transaction_code,
            control_number=healthcare_transaction.header.get("transaction_set_control_number", "")
        )
